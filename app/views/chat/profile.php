<div class="card w-75 mx-auto mt-5">
  ...
  <div class="card-body text-center">
    ...
    <ul class="list-group text-start text-dark">
      ...
      <li class="list-group-item"><strong style="color:<?=$data['user']['color']?>">Date created(UTC+07:00):</strong> <?=$data['user']['date_created']?></li>
    </ul>
    <a class="btn btn-primary w-75 mt-2 <?=$data['user']['id']==$_SESSION['id']?'d-none':''?>" href="<?=BASEURL?>/chat/private"><i class="bi bi-envelope"></i> Private Message</a>
  <?php else: ?>
